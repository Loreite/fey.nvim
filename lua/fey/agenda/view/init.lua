...
---@field lines FeyAgendaLine[]
local FeyAgendaView = {}
FeyAgendaView.__index = FeyAgendaView

---@param opts { bufnr: number, highlighter: FeyHighlighter }
---@return FeyAgendaView
function FeyAgendaView:new(opts)
...
---@param line FeyAgendaLine
function FeyAgendaView:add_line(line)
...
---@return boolean
function FeyAgendaView:is_in_range(line_nr)
  line_nr = line_nr or vim.fn.line('.')
  return line_nr >= self.start_line and line_nr <= self.end_line
end

---@param old_line FeyAgendaLine
---@param new_line FeyAgendaLine
function FeyAgendaView:replace_line(old_line, new_line)
