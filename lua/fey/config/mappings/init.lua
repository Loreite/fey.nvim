...
return {
  ...
  fey = {
    ...
    fey_do_demote = m.action(
      'fey_mappings.do_demote',
      { opts = { desc = 'fey demote heading', help_desc = 'Demote heading' } }
    ),
    fey_promote_subtree = m.action(
      'fey_mappings.do_promote',
      { args = { true }, opts = { desc = 'fey promote subtree', help_desc = 'Promote whole subtree' } }
    ),
    fey_demote_subtree = m.action(
      'fey_mappings.do_demote',
      { args = { true }, opts = { desc = 'fey demote subtree', help_desc = 'Demote whole subtree' } }
    ),
    fey_move_subtree_up = m.action(
      'fey_mappings.move_subtree_up',
      { opts = { desc = 'fey move subtree up', help_desc = 'Move subtree up' } }
    ),
