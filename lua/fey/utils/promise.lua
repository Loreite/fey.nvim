---@alias FeyPromiseState 'pending' | 'fulfilled' | 'rejected'

---@class FeyPromisePackedValues
---@field n integer
---@field [integer] any

---@class FeyPromise<T>
---@field _state FeyPromiseState
---@field _value FeyPromisePackedValues|nil
...
---@return FeyPromisePackedValues
local function pack_values(...)
  return vim.F.pack_len(...)
end

---@param values FeyPromisePackedValues
---@param from? integer
...
---@generic T
---@param fn fun(...: any): T|FeyPromise<T>
...
---@generic T
---@param executor fun(resolve: fun(...: T|FeyPromise<T>), reject: fun(...: any))
---@return FeyPromise<T>
...
---@generic T, U
---@param self FeyPromise<T>
---@param on_fulfilled? fun(...: any): U|FeyPromise<U>
---@param on_rejected? fun(...: any): U|FeyPromise<U>
---@return FeyPromise<T|U>
...
---@generic T, U
---@param self FeyPromise<T>
---@param on_rejected fun(reason: any): U|FeyPromise<U>
---@return FeyPromise<T|U>
...
---@generic T
---@param callback fun(...: any): T|FeyPromise<T>
---@param ... any
---@return FeyPromise<T>
...
---@generic T, U
---@param mapper fun(item: T, index: integer, items: T[]): U|FeyPromise<U>
---@param items T[]
