---@alias FeyTodoKeywordType 'TODO' | 'DONE'

---@class FeyTodoKeyword
---@field keyword string
---@field index number
---@field type FeyTodoKeywordType
---@field value string
...
---@param opts { type: FeyTodoKeywordType, keyword: string, index: number, sequence_index?: number }
