...
---@class FeyCaptureWindowOpts
---@field template FeyCaptureTemplate
---@field on_open? fun(self: FeyCaptureWindow)
---@field on_finish? fun(lines: string[]): string[] | nil
---@field on_close? fun(self: FeyCaptureWindow)

---@class FeyCaptureWindow :FeyCaptureWindowOpts
---@field id number
...
---@param opts FeyCaptureWindowOpts
