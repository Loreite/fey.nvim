...
--
-- http://sputnik.freewisdom.fey/lib/colors/
--
-- License: MIT/X
--
-- (c) 2008 Yuri Takhteyev (yuri@freewisdom.fey) *
--
...
function rgb_string_to_hsl(rgb)
  return rgb_to_hsl(tonumber(rgb:sub(2, 3), 16) / 255, tonumber(rgb:sub(4, 5), 16) / 255, tonumber(rgb:sub(6, 7), 16) / 255)
end
