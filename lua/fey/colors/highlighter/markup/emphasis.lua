...
local markers = {
  ...
  ['_'] = {
    hl_name = '@fey.underline',
    nestable = true,
  },
  ['+'] = {
    hl_name = '@fey.strikethrough',
    nestable = true,
  },
  ['~'] = {
    hl_name = '@fey.code',
...
function FeyEmphasis:is_valid_end_node(entry, source)
  ...
  return (end_text:len() < 3 or vim.tbl_contains(valid_post_marker_chars, end_text:sub(3, 3))) and end_text:sub(1, 1) ~= ' '
end
