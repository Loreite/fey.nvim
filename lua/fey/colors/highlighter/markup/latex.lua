---@class FeyLatexHighlighter : FeyMarkupHighlighter
...
---@param bufnr number
function FeyLatex:highlight(highlights, bufnr)
...
function FeyLatex:prepare_highlights(highlights)
  local ephemeral = self.markup:use_ephemeral()
  local extmarks = {}
  for _, entry in ipairs(highlights) do
