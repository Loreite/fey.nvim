...
---@alias FeyUrlPathType 'file' | 'heading' | 'custom-id' | 'id' | 'external-url' | 'plain' | nil
---@alias FeyUrlTargetType 'heading' | 'custom-id' | 'line-number' | 'unknown' | nil

---@class FeyUrl
---@field url string
---@field protocol string
---@field path string
---@field path_type FeyUrlPathType
---@field realpath string
---@field target { type: FeyUrlTargetType, value: string | number | nil }
local Url = {}
Url.__index = Url
...
---@return boolean
function Url:is_heading()
  return self:is_file_heading() or self:is_internal_heading()
end
...
---@return string | nil
function Url:get_heading()
  if self:is_file_heading() then
    return tostring(self.target.value)
  end
  if self:is_internal_heading() then
    return self.path
  end
  return nil
end
...
---@return boolean
function Url:is_file_heading()
  return self:is_file() and self.target and self.target.type == 'heading' or false
end
...
---@return boolean
function Url:is_internal_heading()
  return self.path_type == 'heading'
end
