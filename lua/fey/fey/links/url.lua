...
local FeyLinkUrl = {}
FeyLinkUrl.__index = FeyLinkUrl

---@param url string
function FeyLinkUrl:new(url)
...
---@return string | nil
function FeyLinkUrl:get_file_path()
...
---@return string
function FeyLinkUrl:get_path_with_protocol()
...
---@return string
function FeyLinkUrl:get_target()
  return self.target
end

---@return string
function FeyLinkUrl:get_path()
  return self.path
end

---@return string
function FeyLinkUrl:get_protocol()
  return self.protocol
end

---@return boolean
function FeyLinkUrl:is_id()
  return self.protocol == 'id'
end

---@return string | nil
function FeyLinkUrl:get_id()
...
function FeyLinkUrl:get_real_path()
  return fs.get_real_path(self.path) or nil
end

---@return string
function FeyLinkUrl:to_string()
  return self.url
end

---@private
function FeyLinkUrl:_parse()
...
---@private
function FeyLinkUrl:_parse_target()
